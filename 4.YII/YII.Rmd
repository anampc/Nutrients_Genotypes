...
YII_Treat_BW<- ggplot(data=subset(YII.data, Spp=="Ac"), aes (Days, YII, colour=factor(Treatment), shape=factor(Treatment))) +
...
Figure3
#ggsave(file="Acer_YII_Treat.svg", plot=Figure3, width=3.5, height=3)
```
...
#ggsave(file="S2b_YII_Treat_Colo.svg", plot=Figure3_genotype, width=6.0, height=3.5)
```

...
str(qPCR.variables)
  ...
  ## Genotype information
    ...
    qPCR.variables<-merge(qPCR.variables, MOTE, 
                            by="Genotype", all.x=TRUE)
    
    qPCR.variables$MoteGen<-factor(as.character(
    qPCR.variables$MoteGen), 
...
logSHTreatment <- ggplot(qPCR.variables, aes(Date, logA.SH, colour=factor(Treatment))) +
       ...
       theme_bw() 
logSHTreatment + facet_wrap(~MoteGen)
...
```{r}
Figure4 <- ggplot (qPCR.variables, aes(Days, logA.SH,
                                       colour=Treatment,
                                       #group=Fragment,
                                       shape=Treatment)) + 
    ...
    theme(legend.position="bottom",
      ...
      annotate("segment", x = 1, xend = 91, y = -2, yend = -2,
                  colour = "gray35", linetype=2)+
      annotate("segment", x = 79, xend = 91, y = -2, yend =0,
...
Figure4 <- ggplot (qPCR.variables_2, aes(Days, logA.SH, colour=Treatment,
    ...
    theme(legend.position="bottom",
      ...
      annotate("segment", x = 73, xend = 91, y = -2, yend = -2,
                  colour = "gray35", linetype=2)+
      annotate("segment", x = 79, xend = 91, y = -2, yend =0,
                  colour = "gray35", linetype=3)+
      annotate("segment", x = 91, xend = 110, y = 0.04, yend = 0.04,

...
logSHTreatment <- ggplot (qPCR.variables, aes(Days, logSH, 
  ...
  Fill.colour +
  ggthe_bw +  theme( legend.position=c(0.1, 0.25),
  ...
  scale_y_continuous(limits = c(-4.6,-0),
                    breaks = seq(-4.5, 0, 0.5),
                    expand = c(0,0),
                  name=("Relative log 10 S/H cell ratio")) +
  scale_x_continuous(name="Days in the experiment",
        ...
        annotate("text", x = 100, y = -3.9, label = "H", size=3, colour="gray")

    
logSHTreatment
logSHTreatmentb<- logSHTreatment+facet_wrap (~Community)
#ggsave(file="Outputs/Fig6b.svg", plot=logSHTreatmentb, width=4.0, height=3.5)
...
logSHTreatment <- ggplot (qPCR.variables_2, aes(Days, logSH, colour=Treatment, shape=Treatment)) + 
  ...
  scale_y_continuous(breaks = seq(-2.5, 0, 0.5),
                    expand = c(0,0),
                  name=("log 10 (relative S/H cell ratio)")) +
  scale_x_continuous(name="Days in the experiment",
                         limits = c(-2,113),
                         breaks = seq(0, 110, 15),  
                         expand = c(0, 0)) +  

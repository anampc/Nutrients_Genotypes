...
```{r}
  ...
  # ggsave(file="Figure_1_Experiment_a.svg", plot=Temperature_BW, width=3.5, height=2)
...
```{r}
  ...
  # ggsave(file="Figure_1_Experiment_b.svg", plot=Temperature_BW2, width=3.5, height=2)

...
```{r}
  ...
  # ggsave(file="Figure_1_Experiment_a.svg", dpi = 300, plot=Temperature_BW, width=3.5, height=2)
...
```{r}
  ...
  # ggsave(file="Figure_1_Experiment_b.svg", plot=Temperature_BW2, dpi = 300, width=3.5, height=2)

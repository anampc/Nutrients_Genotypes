...
#ggsave(file="Outputs/Figure_1_samples.svg", plot=Samples, dpi = 300, width=6, height=4)
...
Temperature_1<- ggplot(Temperature, aes (Day, Temperature)) + theme_bw() +
  ...
  annotate("text", x= c(40, 84, 102), y = c(24.5, 24.5, 24.5), 
             label=c("Phase 1: Control temperature", 
                     "Phase2: \n Ramp-up",
                     "Phase 3:\n Heat stress"), size=3) +
  annotate("segment", x = 2, xend = 78, y = 25, yend = 25,
              colour = "black", linetype=1)+
  annotate("segment", x = 91, xend = 113, y = 26, yend = 26,
              colour = "black", linetype=1)+
  annotate("segment", x = 79, xend = 90, y = 25.5, yend = 25.5,
              colour = "black", linetype=1)+
...
# Samples  
    ...
    annotate("point",x=c(82, 111), y=c(32, 32.5), 
             shape=4, size=2)+
# Labels
    annotate("point",x=c(3, 3), y=c(30, 31), 
               shape=21, size=2, fill="white")+
    annotate("point",x=c(3), y=c(30), 
               shape=4, size=2)+
    annotate("text", x= c(28,25), y = c(30.0,31), 
                 label=c( "Sacrificial samples - censored events",
                         "Microbiome samples"), size=3)
  
Temperature_1
  
#ggsave(file="Outputs/Figure_1_Experiment_d.svg", plot=Temperature_BW2, dpi = 300, width=6, height=4)

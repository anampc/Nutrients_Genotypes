...
## 4.1 Ambient versus elevated nutrients (N and N+p pooled) 

```{r}
# Claculate relative changes (1 - Ambinet)
...
## All genotypes by nutrient treatment over time (percentaje)
...
# 5. Growth over time (control, ramp-up and heat stress phases) by nutrient treatment (By genotype, but N and N+P pooled)

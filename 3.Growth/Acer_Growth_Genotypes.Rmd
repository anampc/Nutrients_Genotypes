...
BW_Col <- ggplot(BW.Tall, aes(Days, dAW.gd, fill=Treatment,
     ...
     annotate("segment", x = -30, xend = -2, y = -1.5, yend = -1.5,
      ...
      annotate("segment", x = 79, xend = 91, y = -1.4, yend = 5,
                colour = "gray35", linetype="dotted")+
    
      annotate("segment", x = 91, xend = 110, y = 5, yend = 5,
                colour = "gray35",  linetype="dotted")+
...
BW_Col2 <- ggplot(BW.Tall, aes(Days, dAW.gd, colour=MoteGen)) + 
  ggthe_bw +
  ...
  annotate("segment", x = 79, xend = 91, y = -2.5, yend = 4,

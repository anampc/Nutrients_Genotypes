...
# ggsave(file="Outputs/AllB_Acer_Ofav_Ssid_Blastate.svg", Sym_CommunityB, width=6, height=5.5)
...
#ggsave(file="Outputs/AllB_Acer_Ofav_Ssid_Chla.svg", Chl_TreatmentB, width=6, height=5.5)

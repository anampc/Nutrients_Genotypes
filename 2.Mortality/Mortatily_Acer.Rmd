...
# Only treatment model
    ...
    #ggsave("Outputs/Fig_Acer_Surv_Treatment.svg", 
     #      Ac_Treatment_Only$plot, width=4, height=3.5,dpi = 300)
    #ggsave("Outputs/Fig_2_Surv_Treatment.pdf", print(Ac_Treatment_Only),
...
## 2. Only nutrients (N and N+P) models
...
HazardRatio
fit.coxph0_2
surv_pvalue(fit.coxph0_2)

#ggsave("Outputs/Fig_1b_HazardRatio.svg", HazardRatio, width=5, height=4,dpi = 300)

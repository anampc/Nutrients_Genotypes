...
# Only treatment model
    ...
    survdiff(surv_object~Treatment, data = Survival.data)
...
# Treatment and genotype model 1 
    ...
    survdiff(surv_object~ Genotype + Treatment, data = Survival.data)
```
...
# Only genotype model
  ...
  # Kaplan-Meier estimator. The "log-log" confidence interval is preferred.
    ...
    survdiff(surv_object2 ~ Genotype, data = Survival.data2)

...
# Only treatment model
    ...
    Treatment_Only
    ggsave("Fig_2_Surv_Treatment.svg", 
           Treatment_Only$plot, width=4, height=3.5,dpi = 300)
    ggsave("Fig_2_Surv_Treatment.pdf", print(Treatment_Only),
...
# Only genotype model
  ...
  # Plot the survival model
    ...
    ggsave("Fig_2_Surv_Genotype.svg", 
           Genotype_only2$plot, width=4.5, height=3.5,dpi = 300)
    ggsave("Fig_2_Surv_Genotype.pdf", print(Genotype_only2),
...
fit.coxph0_2
    ...
    ggsave("Fig_S1_HazardRatio.svg", 
           HazardRatio, width=6, height=4,dpi = 300)

...
# ggsave(file="Figure2_BW.svg", plot=BW_Treat, dpi = 300, units="in", width=3.5, height=3.0)
```
...
BW_ColonyT<- ggplot(BW.Tall, aes (Days, dBW.g, colour=MoteGen)) +   
...
# Pair-wise comparisons
  ...
  write.csv(BW_groups, "BW_groups.csv", row.names = F)
